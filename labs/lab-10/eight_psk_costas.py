...
class eight_psk_costas(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "eight_psk_costas")
...
def main(top_block_cls=eight_psk_costas, options=None):
