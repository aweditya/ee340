...
class frequency_demodulator(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "frequency_demodulator")
...
def main(top_block_cls=frequency_demodulator, options=None):
