...
class viterbi_viterbi(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "viterbi_viterbi")
        ...
        # Connections
        ##################################################
        self.connect((self.analog_phase_modulator_fc_0, 0), (self.blocks_multiply_xx_2, 1))
...
def main(top_block_cls=viterbi_viterbi, options=None):
