...
class end_to_end_differential_bpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "end_to_end_differential_bpsk")
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_fff(sps, 2*3.14159256/100, firdes.root_raised_cosine(4,32*sps*symb_rate,symb_rate,0.99,11*sps), 32, 16, 1.5, 1)
        ...
        self.blocks_skiphead_0_0 = blocks.skiphead(gr.sizeof_char*1, 21)
        ...
        self.connect((self.blocks_float_to_uchar_0_0, 0), (self.blocks_skiphead_0_0, 0))
        ...
        self.connect((self.blocks_skiphead_0_0, 0), (self.digital_diff_decoder_bb_0, 0))
        self.connect((self.blocks_threshold_ff_0, 0), (self.blocks_float_to_uchar_0_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.blocks_multiply_xx_1, 1))
        self.connect((self.blocks_unpack_k_bits_bb_0_0, 0), (self.digital_diff_encoder_bb_0, 0))
        self.connect((self.digital_chunks_to_symbols_xx_0, 0), (self.pfb_arb_resampler_xxx_0, 0))
        self.connect((self.digital_diff_decoder_bb_0, 0), (self.blocks_pack_k_bits_bb_0_0, 0))
...
def main(top_block_cls=end_to_end_differential_bpsk, options=None):
