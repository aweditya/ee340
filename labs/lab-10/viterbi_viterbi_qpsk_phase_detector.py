...
class viterbi_viterbi_qpsk_phase_detector(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "viterbi_viterbi_qpsk_phase_detector")
        ...
        self.plots.addTab(self.plots_widget_2, 'Viterbi-Viterbi Algorithm')
        ...
        self.plots_layout_1.addWidget(self._qtgui_time_sink_x_0_0_win)
        ...
        self.plots_layout_2.addWidget(self._qtgui_const_sink_x_2_win)
        ...
        self.pfb_arb_resampler_xxx_0 = pfb.arb_resampler_ccf(
            sps,
            taps=firdes.root_raised_cosine(5,samp_rate,samp_rate/sps,0.99,11*sps),
            flt_size=32)
        self.pfb_arb_resampler_xxx_0.declare_sample_delay(0)
        self.iir_filter_xxx_0_0 = filter.iir_filter_ffd([0.01], [-1,0.99], True)
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(sps, 2*3.14159265/100, firdes.root_raised_cosine(5,32*samp_rate,samp_rate/sps,0.99,11*sps), 32, 16, 1.5, 1)
        ...
        self.connect((self.blocks_multiply_conjugate_cc_0, 0), (self.qtgui_const_sink_x_2, 0))
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.digital_pfb_clock_sync_xxx_0.update_taps(firdes.root_raised_cosine(5,32*self.samp_rate,self.samp_rate/self.sps,0.99,11*self.sps))
        self.pfb_arb_resampler_xxx_0.set_taps(firdes.root_raised_cosine(5,self.samp_rate,self.samp_rate/self.sps,0.99,11*self.sps))
...
def main(top_block_cls=viterbi_viterbi_qpsk_phase_detector, options=None):
