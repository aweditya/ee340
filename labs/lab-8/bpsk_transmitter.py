...
class bpsk_transmitter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.plot.addTab(self.plot_widget_0, '')
        ...
        self.plot_widget_2 = Qt.QWidget()
        self.plot_layout_2 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.plot_widget_2)
        self.plot_grid_layout_2 = Qt.QGridLayout()
        self.plot_layout_2.addLayout(self.plot_grid_layout_2)
        self.plot.addTab(self.plot_widget_2, 'Tab 2')
        self.plot_widget_3 = Qt.QWidget()
        self.plot_layout_3 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.plot_widget_3)
        self.plot_grid_layout_3 = Qt.QGridLayout()
        self.plot_layout_3.addLayout(self.plot_grid_layout_3)
        self.plot.addTab(self.plot_widget_3, 'Tab 3')
        ...
        self.plot_layout_3.addWidget(self._qtgui_time_sink_x_1_win)
        ...
        self.plot_layout_2.addWidget(self._qtgui_time_sink_x_0_0_0_win)
        ...
        self.plot_layout_0.addWidget(self._qtgui_time_sink_x_0_0_win)
        ...
        self.plot_layout_2.addWidget(self._qtgui_const_sink_x_1_win)
        ...
        self.plot_layout_3.addWidget(self._qtgui_const_sink_x_0_0_0_win)
        ...
        self.plot_layout_1.addWidget(self._qtgui_const_sink_x_0_0_win)
        ...
        self.blocks_threshold_ff_0_0 = blocks.threshold_ff(-0.01, 0.01, 0)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(quad_rate, analog.GR_COS_WAVE, 100000, 1, 0, 1.5707963267948966)
        ...
        self.connect((self.blocks_add_const_vxx_0_0, 0), (self.blocks_float_to_complex_1, 1))
        self.connect((self.blocks_add_const_vxx_0_0, 0), (self.qtgui_time_sink_x_1, 1))
        ...
        self.connect((self.blocks_float_to_complex_1, 0), (self.qtgui_const_sink_x_0_0_0, 0))
        ...
        self.connect((self.root_raised_cosine_filter_0_0, 0), (self.blocks_complex_to_imag_0, 0))
        self.connect((self.root_raised_cosine_filter_0_0, 0), (self.blocks_complex_to_real_1, 0))
        self.connect((self.root_raised_cosine_filter_0_0, 0), (self.qtgui_const_sink_x_1, 0))
        self.connect((self.root_raised_cosine_filter_0_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
    ...
    def set_symb_rate(self, symb_rate):
        ...
        self.qtgui_time_sink_x_0_0.set_samp_rate(self.symb_rate*self.sps)
        self.qtgui_time_sink_x_0_0_0.set_samp_rate(self.symb_rate*self.sps)
        self.qtgui_time_sink_x_1.set_samp_rate(self.symb_rate*self.sps)
        self.root_raised_cosine_filter_0.set_taps(firdes.root_raised_cosine(3, self.symb_rate*self.sps, self.symb_rate, 0.5, 11*self.sps))
        self.root_raised_cosine_filter_0_0.set_taps(firdes.root_raised_cosine(3, self.symb_rate*self.sps, self.symb_rate, 0.5, 11*self.sps))
    ...
    def set_quad_rate(self, quad_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.quad_rate, 50000, 1000, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.quad_rate, 50000, 1000, window.WIN_HAMMING, 6.76))
