...
class order_2_non_linearity(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "order_2_non_linearity")
        ...
        # Blocks
        ##################################################
        self._Av_range = Range(10e-6, 0.01, 10e-8, 10e-6, 200)
...
def main(top_block_cls=order_2_non_linearity, options=None):
