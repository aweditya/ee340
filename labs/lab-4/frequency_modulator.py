...
class frequency_modulator(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "frequency_modulator")
...
def main(top_block_cls=frequency_modulator, options=None):
