...
class qpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.tab.addTab(self.tab_widget_2, 'qpsk')
        ...
        self.tab_layout_0.addWidget(self._qtgui_const_sink_x_0_1_win)
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.qtgui_const_sink_x_0_1, 0))
