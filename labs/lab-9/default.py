...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.plot.addTab(self.plot_widget_0, 'Tab 0')
        ...
        self.plot.addTab(self.plot_widget_1, 'Tab 1')
        self.top_layout.addWidget(self.plot)
        self._noise_amp_range = Range(0, 1, 0.001, 0.0, 200)
        ...
        self._b3_range = Range(-1, 1, 0.0001, 0.0625, 200)
        self._b3_win = RangeWidget(self._b3_range, self.set_b3, "'b3'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._b3_win)
        self._b2_range = Range(-1, 1, 0.0001, -0.125, 200)
        self._b2_win = RangeWidget(self._b2_range, self.set_b2, "'b2'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._b2_win)
        self._b1_range = Range(-1, 1, 0.0001, 0.25, 200)
        self._b1_win = RangeWidget(self._b1_range, self.set_b1, "'b1'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._b1_win)
        self._b0_range = Range(-1, 1, 0.0001, -0.5, 200)
        self._b0_win = RangeWidget(self._b0_range, self.set_b0, "'b0'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._b0_win)
        ...
        self.plot_layout_1.addWidget(self._qtgui_const_sink_x_1_win)
        ...
        self.plot_layout_0.addWidget(self._qtgui_const_sink_x_0_win)
        ...
        self.low_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.iir_filter_xxx_0 = filter.iir_filter_ccf([0.01], [1,0.98], True)
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(sps, 2*3.141/100, firdes.root_raised_cosine(1,32*sps*symb_rate,symb_rate,0.90,11*sps*32), 32, 16, 1.5, 1)
        ...
        self.blocks_multiply_const_vxx_1_0_0_0 = blocks.multiply_const_cc(b3)
        self.blocks_multiply_const_vxx_1_0_0 = blocks.multiply_const_cc(b2)
        self.blocks_multiply_const_vxx_1_0 = blocks.multiply_const_cc(b1)
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_cc(b0)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(0.5)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.blocks_delay_1_0_0_0 = blocks.delay(gr.sizeof_gr_complex*1, 4)
        self.blocks_delay_1_0_0 = blocks.delay(gr.sizeof_gr_complex*1, 3)
        ...
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_conjugate_cc_0, 0))
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_multiply_xx_2, 1))
        self.connect((self.blocks_add_xx_1, 0), (self.qtgui_const_sink_x_1, 0))
        self.connect((self.blocks_add_xx_2, 0), (self.blocks_throttle_0, 0))
        self.connect((self.blocks_complex_to_real_0, 0), (self.blocks_add_xx_2, 1))
        ...
        self.connect((self.blocks_multiply_xx_2, 0), (self.blocks_add_const_vxx_0, 0))
        ...
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.blocks_add_xx_1, 0))
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.blocks_delay_1, 0))
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.blocks_delay_1_0, 0))
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.blocks_delay_1_0_0, 0))
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.blocks_delay_1_0_0_0, 0))
    ...
    def set_symb_rate(self, symb_rate):
        ...
        self.digital_pfb_clock_sync_xxx_0.update_taps(firdes.root_raised_cosine(1,32*self.sps*self.symb_rate,self.symb_rate,0.90,11*self.sps*32))
        self.pfb_arb_resampler_xxx_0.set_taps(firdes.root_raised_cosine(1,self.sps*self.symb_rate,self.symb_rate,0.90,11*self.sps*32))
    ...
    def set_b3(self, b3):
        self.b3 = b3
        self.blocks_multiply_const_vxx_1_0_0_0.set_k(self.b3)
    ...
    def set_b1(self, b1):
        self.b1 = b1
        self.blocks_multiply_const_vxx_1_0.set_k(self.b1)
    ...
    def set_b0(self, b0):
        self.b0 = b0
        self.blocks_multiply_const_vxx_1.set_k(self.b0)
