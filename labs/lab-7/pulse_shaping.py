...
class pulse_shaping(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "pulse_shaping")
        ...
        self.tab_layout_3.addWidget(self._qtgui_eye_sink_x_0_win)
        ...
        self.blocks_throttle_0_0 = blocks.throttle(gr.sizeof_float*1, symb_rate*sps,True)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, symb_rate*sps,True)
        ...
        self.connect((self.blocks_complex_to_imag_0_0, 0), (self.blocks_throttle_0_0, 0))
        ...
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.blocks_complex_to_imag_0, 0))
        ...
        self.connect((self.root_raised_cosine_filter_0, 0), (self.blocks_complex_to_imag_0_0, 0))
    ...
    def set_symb_rate(self, symb_rate):
        ...
        self.blocks_throttle_0.set_sample_rate(self.symb_rate*self.sps)
        self.blocks_throttle_0_0.set_sample_rate(self.symb_rate*self.sps)
        self.qtgui_eye_sink_x_0.set_samp_rate(self.symb_rate*self.sps)
        ...
        self.qtgui_time_sink_x_1_0.set_samp_rate(self.symb_rate*self.sps)
