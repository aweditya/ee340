...
class cma(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "cma")
        ...
        self.pfb_arb_resampler_xxx_0 = pfb.arb_resampler_ccf(
            sps,
            taps=firdes.root_raised_cosine(3,sps*symb_rate,symb_rate,0.90,11*sps*32),
            flt_size=32)
        ...
        self.low_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self._gain_range = Range(0, 1, 0.0001, 0, 200)
        self._gain_win = RangeWidget(self._gain_range, self.set_gain, "'gain'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._gain_win)
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(sps, 2*3.141/100, firdes.root_raised_cosine(3,32*sps*symb_rate,symb_rate,0.90,11*sps*32), 32, 16, 1.5, 1)
        self.digital_cma_equalizer_cc_0 = digital.cma_equalizer_cc(4, 1.414, 400e-6, 1)
    ...
    def set_symb_rate(self, symb_rate):
        ...
        self.digital_pfb_clock_sync_xxx_0.update_taps(firdes.root_raised_cosine(3,32*self.sps*self.symb_rate,self.symb_rate,0.90,11*self.sps*32))
        self.pfb_arb_resampler_xxx_0.set_taps(firdes.root_raised_cosine(3,self.sps*self.symb_rate,self.symb_rate,0.90,11*self.sps*32))
...
def main(top_block_cls=cma, options=None):
