...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._noise_amp_range = Range(0, 1, 0.001, 0, 200)
        ...
        self.blocks_threshold_ff_0 = blocks.threshold_ff(-0.0005, 0.0005, 0)
        self.blocks_skiphead_0 = blocks.skiphead(gr.sizeof_char*1, 5)
        self.blocks_pack_k_bits_bb_0 = blocks.pack_k_bits_bb(8)
        self.blocks_multiply_xx_1 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_float_to_uchar_0 = blocks.float_to_uchar()
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/aditya/Projects/iitb/ee340/labs/lab-8/in.txt', False, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/aditya/Projects/iitb/ee340/labs/lab-8/out.txt', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_complex_to_real_0 = blocks.complex_to_real(1)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(quad_rate, analog.GR_COS_WAVE, 100000, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(quad_rate, analog.GR_COS_WAVE, 100000, 1, 0, 0)
    ...
    def set_symb_rate(self, symb_rate):
        ...
        self.root_raised_cosine_filter_0.set_taps(firdes.root_raised_cosine(1, self.symb_rate*self.sps, self.symb_rate, 0.99, 11*self.sps))
        self.root_raised_cosine_filter_0_0.set_taps(firdes.root_raised_cosine(3, self.symb_rate*self.sps, self.symb_rate, 0.99, 11*self.sps))
