...
class equalizer_design(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "equalizer_design")
        ...
        self.blocks_multiply_const_vxx_1_0_0_0 = blocks.multiply_const_cc(0.0625)
        self.blocks_multiply_const_vxx_1_0_0 = blocks.multiply_const_cc(-0.125)
    ...
    def set_symb_rate(self, symb_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.sps*self.symb_rate)
...
def main(top_block_cls=equalizer_design, options=None):
