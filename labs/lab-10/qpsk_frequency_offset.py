...
class qpsk_frequency_offset(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "qpsk_frequency_offset")
...
def main(top_block_cls=qpsk_frequency_offset, options=None):
