...
class equalization(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.plot_widget_4 = Qt.QWidget()
        self.plot_layout_4 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.plot_widget_4)
        self.plot_grid_layout_4 = Qt.QGridLayout()
        self.plot_layout_4.addLayout(self.plot_grid_layout_4)
        self.plot.addTab(self.plot_widget_4, 'Tab 4')
        ...
        self.plot_layout_2.addWidget(self._qtgui_time_sink_x_0_0_0_0_win)
        ...
        self.plot_layout_3.addWidget(self._qtgui_time_sink_x_0_0_win)
        ...
        self.plot_layout_3.addWidget(self._qtgui_time_sink_x_0_win)
        ...
        self.plot_layout_4.addWidget(self._qtgui_const_sink_x_1_win)
        ...
        self.blocks_multiply_const_vxx_1_0_0_0 = blocks.multiply_const_ff(0.0625)
        self.blocks_multiply_const_vxx_1_0_0 = blocks.multiply_const_ff(-0.125)
    ...
    def set_symb_rate(self, symb_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.symb_rate*self.sps)
        ...
        self.qtgui_time_sink_x_0_0_0_0.set_samp_rate(self.symb_rate*self.sps)
        self.root_raised_cosine_filter_0.set_taps(firdes.root_raised_cosine(2, self.symb_rate*self.sps, self.symb_rate, 0.99, 11*self.sps))
        self.root_raised_cosine_filter_0_0.set_taps(firdes.root_raised_cosine(2, self.symb_rate*self.sps, self.symb_rate, 0.99, 11*self.sps))
