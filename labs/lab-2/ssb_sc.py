...
class ssb_sc(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_throttle_0_0 = blocks.throttle(gr.sizeof_float*1, audio_rate,True)
        ...
        self.analog_sig_source_x_0_0_1 = analog.sig_source_f(quadrature_rate, analog.GR_SIN_WAVE, 200000, 1, 0, 0)
        self.analog_sig_source_x_0_0_0_0 = analog.sig_source_f(quadrature_rate, analog.GR_COS_WAVE, 200000, 1, 0, 0)
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(quadrature_rate, analog.GR_COS_WAVE, 200000, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(quadrature_rate, analog.GR_SIN_WAVE, 200000, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_0_0_0, 0), (self.blocks_multiply_xx_1, 0))
        self.connect((self.analog_sig_source_x_0_0_1, 0), (self.blocks_multiply_xx_1_0, 1))
        ...
        self.connect((self.rational_resampler_xxx_1, 0), (self.blocks_throttle_0_0, 0))
        self.connect((self.rational_resampler_xxx_1_0, 0), (self.blocks_throttle_0, 0))
    ...
    def set_quadrature_rate(self, quadrature_rate):
        ...
        self.analog_sig_source_x_0_0_1.set_sampling_freq(self.quadrature_rate)
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.quadrature_rate, 10000, 1000, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.quadrature_rate, 10000, 1000, window.WIN_HAMMING, 6.76))
    ...
    def set_audio_rate(self, audio_rate):
        ...
        self.blocks_throttle_0_0.set_sample_rate(self.audio_rate)
