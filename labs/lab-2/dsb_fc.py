...
class dsb_fc(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "dsb_fc")
        ...
        self.amplification = amplification = 1
        ...
        self._amplification_range = Range(-4, 4, 0.05, 1, 200)
        self._amplification_win = RangeWidget(self._amplification_range, self.set_amplification, "'amplification'", "slider", float, QtCore.Qt.Horizontal)
        self.tab_layout_1.addWidget(self._amplification_win)
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self._dc_level_range = Range(-2, 2, 0.05, 0, 200)
        self._dc_level_win = RangeWidget(self._dc_level_range, self.set_dc_level, "'dc_level'", "slider", float, QtCore.Qt.Horizontal)
        self.tab_layout_1.addWidget(self._dc_level_win)
        ...
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_ff(amplification)
        ...
        self.connect((self.blocks_throttle_0_0, 0), (self.qtgui_time_sink_x_2, 0))
    ...
    def set_amplification(self, amplification):
        ...
        self.blocks_multiply_const_vxx_1.set_k(self.amplification)




def main(top_block_cls=dsb_fc, options=None):
