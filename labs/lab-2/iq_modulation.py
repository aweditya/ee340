...
class iq_modulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "iq_modulation")
        ...
        self.blocks_wavfile_source_0_0 = blocks.wavfile_source('/home/aditya/Projects/iitb/ee340/labs/audio/background.wav', True)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, 'data/data1.dat', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.audio_sink_0 = audio.sink(44100, '', True)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(quadrature_rate, analog.GR_COS_WAVE, 100000, 1, 0, 1.57079632679)
        ...
        self.connect((self.blocks_wavfile_source_0_0, 0), (self.audio_sink_0, 0))
...
def main(top_block_cls=iq_modulation, options=None):
