...
class emphasis(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "emphasis")
        ...
        self.iir_filter_xxx_1 = filter.iir_filter_ffd([1, -0.5], [1], True)
        ...
        self.analog_sig_source_x_1_0_0 = analog.sig_source_f(quadrature_rate, analog.GR_COS_WAVE, 400000, 1, 0, 1.57)
        self.analog_sig_source_x_1_0 = analog.sig_source_f(quadrature_rate, analog.GR_COS_WAVE, 400000, 1, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_c(quadrature_rate, analog.GR_COS_WAVE, 400000, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(audio_rate, analog.GR_COS_WAVE, 11000, 0.5, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(audio_rate, analog.GR_COS_WAVE, 1100, 0.5, 0, 0)
        self.analog_phase_modulator_fc_0 = analog.phase_modulator_fc(75000 * 2 * 3.141)
        ...
        self.connect((self.analog_sig_source_x_1_0, 0), (self.blocks_multiply_xx_2, 0))
        self.connect((self.analog_sig_source_x_1_0_0, 0), (self.blocks_multiply_xx_2_0, 1))
        ...
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_multiply_xx_2_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_2_0, 0), (self.low_pass_filter_0_0, 0))
    ...
    def set_quadrature_rate(self, quadrature_rate):
        ...
        self.analog_sig_source_x_1_0.set_sampling_freq(self.quadrature_rate)
        self.analog_sig_source_x_1_0_0.set_sampling_freq(self.quadrature_rate)
        self.low_pass_filter_0.set_taps(firdes.low_pass(2, self.quadrature_rate, 200000, 10000, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(2, self.quadrature_rate, 200000, 10000, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=emphasis, options=None):
