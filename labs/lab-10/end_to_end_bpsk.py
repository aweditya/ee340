...
class end_to_end_bpsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "end_to_end_bpsk")
        ...
        self.blocks_skiphead_0_0 = blocks.skiphead(gr.sizeof_char*1, 13)
        ...
        self.connect((self.blocks_unpack_k_bits_bb_0_0, 0), (self.digital_chunks_to_symbols_xx_0, 0))
...
def main(top_block_cls=end_to_end_bpsk, options=None):
